...
include { samtools_stats as samtools_intial_stats }             from '../modules/samtools'  addParams(samtools_stats: params.samtools_stats, samtools_stats_options: params.samtools_stats_options, trimmer: params.trimmer)
